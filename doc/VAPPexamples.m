...
%link: https://nanohub.org/publications/95/2
%
...
%a modified MVS FET model. To construct a negative capacitance FET model, these
%the negative capacitance model is attached to the gate terminal of the FET
%model and the two auxiliary terminals (qg_as_v) in both models are connected
%together.
%
%The analysis in this example is a special feature of MAPP, homotopy. We
%connect the drain and the gate terminals of the negative capacitance FET
%together (diode mode) and run a DC analysis. However, this analysis captures
%the hysteresis behavior of the model created by the negative capacitance.
%
...
%      with a differential capacitance value that is negative in some bias
%      regions. To see this curve, execute the script 
%      'run_neg_cap_3t_dcsweep.m'.
%
