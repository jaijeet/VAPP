...
%==============================================================================
    ...
    properties (Access = private)
        inputList = {};
        outputList = {};
        auxFuncVec = IrNodeAnalogFunction.empty;
    end
