classdef MsParameter < MsComparableViaLabel
...
%==============================================================================
    ...
    methods
        ...
        function setDependParmVecC(thisParm, parmVecC)
        % SETDEPENDPARMVECC
            thisParm.dependParmVecC = parmVecC;
        end
        ...
        % SETINNODECOLLAPSE
            ...
            for dependParm = thisParm.dependParmVecC
        ...
        function parmVecC = getDependParmVecC(thisParm)
        % GETDEPENDPARMVECC
            parmVecC = thisParm.dependParmVecC;
        end
