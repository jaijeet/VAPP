...
%===============================================================================
    ...
    MOD.model_name = 'mvs_5t_mod';
    MOD.NIL.node_names = {'d', 'g', 's', 'qg_as_v', 'b'};
    MOD.NIL.refnode_name = 'b';

    parmNameDefValArr = {'parm_version', 1.01,...
                         'parm_type', 1,...
                         'parm_W', 0.0001,...
                         'parm_Lgdr', 8e-06,...
                         'parm_dLg', 1.05e-06,...
...
function [fe__, qe__, fi__, qi__,...
    ...
    parm_leak_select = MOD__.parm_vals{26};
    ...
    d_FF_d_v_gb__ = 0;
    d_FF_d_v_sb__ = 0;
    d_FF_vgs0_d_v_bsi__ = 0;
    d_FF_vgs0_d_v_db__ = 0;
    d_FF_vgs0_d_v_disi__ = 0;
    d_FF_vgs0_d_v_gb__ = 0;
    d_FF_vgs0_d_v_sb__ = 0;
    d_FFpre_d_v_bsi__ = 0;
    d_FFpre_d_v_db__ = 0;
    ...
    d_Fsat_d_v_gb__ = 0;
    d_Fsat_d_v_sb__ = 0;
    d_Fsat_vgs0_d_v_bsi__ = 0;
    d_Fsat_vgs0_d_v_db__ = 0;
    d_Fsat_vgs0_d_v_disi__ = 0;
    d_Fsat_vgs0_d_v_gb__ = 0;
    d_Fsat_vgs0_d_v_sb__ = 0;
    d_Fsatq_d_v_bsi__ = 0;
    d_Fsatq_d_v_db__ = 0;
    ...
    d_Id_d_v_gb__ = 0;
    d_Id_d_v_sb__ = 0;
    d_Id_vgs0_d_v_bsi__ = 0;
    d_Id_vgs0_d_v_db__ = 0;
    d_Id_vgs0_d_v_disi__ = 0;
    d_Id_vgs0_d_v_gb__ = 0;
    d_Id_vgs0_d_v_sb__ = 0;
    d_Qb_d_v_bsi__ = 0;
    d_Qb_d_v_db__ = 0;
    d_Qb_d_v_disi__ = 0;
    d_Qb_d_v_gb__ = 0;
    ...
    d_Qinv_corr_vgs0_d_v_bsi__ = 0;
    d_Qinv_corr_vgs0_d_v_db__ = 0;
    d_Qinv_corr_vgs0_d_v_disi__ = 0;
    d_Qinv_corr_vgs0_d_v_gb__ = 0;
    d_Qinv_corr_vgs0_d_v_sb__ = 0;
    d_Qinv_d_v_bsi__ = 0;
    d_Qinv_d_v_db__ = 0;
    d_Qinv_d_v_disi__ = 0;
    d_Qinv_d_v_gb__ = 0;
    ...
    d_Vdbeta_d_v_gb__ = 0;
    d_Vdbeta_d_v_sb__ = 0;
    d_Vdbeta_vgs0_d_v_bsi__ = 0;
    d_Vdbeta_vgs0_d_v_db__ = 0;
    d_Vdbeta_vgs0_d_v_disi__ = 0;
    d_Vdbeta_vgs0_d_v_gb__ = 0;
    d_Vdbeta_vgs0_d_v_sb__ = 0;
    d_Vdbetabeta_d_v_bsi__ = 0;
    d_Vdbetabeta_d_v_db__ = 0;
    d_Vdbetabeta_d_v_disi__ = 0;
    d_Vdbetabeta_d_v_gb__ = 0;
    d_Vdbetabeta_d_v_sb__ = 0;
    d_Vdbetabeta_vgs0_d_v_bsi__ = 0;
    d_Vdbetabeta_vgs0_d_v_db__ = 0;
    d_Vdbetabeta_vgs0_d_v_disi__ = 0;
    d_Vdbetabeta_vgs0_d_v_gb__ = 0;
    d_Vdbetabeta_vgs0_d_v_sb__ = 0;
    d_Vdratio_d_v_bsi__ = 0;
    d_Vdratio_d_v_db__ = 0;
    d_Vdratio_d_v_disi__ = 0;
    d_Vdratio_d_v_gb__ = 0;
    d_Vdratio_d_v_sb__ = 0;
    d_Vdratio_vgs0_d_v_bsi__ = 0;
    d_Vdratio_vgs0_d_v_db__ = 0;
    d_Vdratio_vgs0_d_v_disi__ = 0;
    d_Vdratio_vgs0_d_v_gb__ = 0;
    d_Vdratio_vgs0_d_v_sb__ = 0;
    d_Vds_d_v_bsi__ = 0;
    d_Vds_d_v_db__ = 0;
    d_Vds_d_v_disi__ = 0;
    d_Vds_d_v_gb__ = 0;
    ...
    d_Vdsat_d_v_gb__ = 0;
    d_Vdsat_d_v_sb__ = 0;
    d_Vdsat_vgs0_d_v_bsi__ = 0;
    d_Vdsat_vgs0_d_v_db__ = 0;
    d_Vdsat_vgs0_d_v_disi__ = 0;
    d_Vdsat_vgs0_d_v_gb__ = 0;
    d_Vdsat_vgs0_d_v_sb__ = 0;
    ...
    d_Vt0bs0_d_v_gb__ = 0;
    d_Vt0bs0_vgs0_d_v_bsi__ = 0;
    d_Vt0bs0_vgs0_d_v_db__ = 0;
    d_Vt0bs0_vgs0_d_v_disi__ = 0;
    d_Vt0bs0_vgs0_d_v_gb__ = 0;
    d_Vt0bs0_vgs0_d_v_sb__ = 0;
    d_Vt0bs_d_v_bsi__ = 0;
    d_Vt0bs_d_v_db__ = 0;
    ...
    d_eVg_d_v_gb__ = 0;
    d_eVg_d_v_sb__ = 0;
    d_eVg_vgs0_d_v_bsi__ = 0;
    d_eVg_vgs0_d_v_db__ = 0;
    d_eVg_vgs0_d_v_disi__ = 0;
    d_eVg_vgs0_d_v_gb__ = 0;
    d_eVg_vgs0_d_v_sb__ = 0;
    ...
    d_eta_d_v_gb__ = 0;
    d_eta_d_v_sb__ = 0;
    d_eta_vgs0_d_v_bsi__ = 0;
    d_eta_vgs0_d_v_db__ = 0;
    d_eta_vgs0_d_v_disi__ = 0;
    d_eta_vgs0_d_v_gb__ = 0;
    d_eta_vgs0_d_v_sb__ = 0;
    d_etai_d_v_bsi__ = 0;
    d_etai_d_v_db__ = 0;
    d_etai_d_v_disi__ = 0;
    d_etai_d_v_gb__ = 0;
    ...
    d_f_v_qg_as_vg_d_v_bsi__ = 0;
    d_f_v_qg_as_vg_d_v_db__ = 0;
    d_f_v_qg_as_vg_d_v_disi__ = 0;
    d_f_v_qg_as_vg_d_v_gb__ = 0;
    d_f_v_qg_as_vg_d_v_sb__ = 0;
    d_kq2_d_v_bsi__ = 0;
    d_kq2_d_v_disi__ = 0;
    d_kq2_d_v_gb__ = 0;
    d_kq4_d_v_bsi__ = 0;
    ...
    d_q_v_qg_as_vg_d_v_bsi__ = 0;
    d_q_v_qg_as_vg_d_v_db__ = 0;
    d_q_v_qg_as_vg_d_v_disi__ = 0;
    d_q_v_qg_as_vg_d_v_gb__ = 0;
    d_q_v_qg_as_vg_d_v_sb__ = 0;
    d_qd_d_v_bsi__ = 0;
    d_qd_d_v_db__ = 0;
    d_qd_d_v_disi__ = 0;
    d_qd_d_v_gb__ = 0;
    ...
    v_gb__ = vecX__(2);
    v_sb__ = vecX__(3);
    v_qg_as_vb__ = vecX__(4);
    v_disi__ = vecY__(1);
    v_bsi__ = vecY__(2);
    i_qg_as_vg__ = vecY__(3);
    ...
    me = 9.1e-31*parm_mc;
        d_n_d_v_db__ = (parm_nd*d_Vds_d_v_db__);
        d_n_d_v_gb__ = (parm_nd*d_Vds_d_v_gb__);
        d_n_d_v_sb__ = (parm_nd*d_Vds_d_v_sb__);
        d_n_d_v_disi__ = (parm_nd*d_Vds_d_v_disi__);
        d_n_d_v_bsi__ = (parm_nd*d_Vds_d_v_bsi__);
    n = parm_n0+parm_nd*Vds;
        d_nphit_d_v_db__ = d_n_d_v_db__*phit;
        d_nphit_d_v_gb__ = d_n_d_v_gb__*phit;
        d_nphit_d_v_sb__ = d_n_d_v_sb__*phit;
    ...
    FF0 = 1/(1+eVg0);
        d_Qref_d_v_db__ = parm_Cg*d_nphit_d_v_db__;
        d_Qref_d_v_gb__ = parm_Cg*d_nphit_d_v_gb__;
        d_Qref_d_v_sb__ = parm_Cg*d_nphit_d_v_sb__;
        d_Qref_d_v_disi__ = parm_Cg*d_nphit_d_v_disi__;
        d_Qref_d_v_bsi__ = parm_Cg*d_nphit_d_v_bsi__;
    Qref = parm_Cg*nphit;
        d_eta_d_v_db__ = (d_Vgscorr_d_v_db__-((d_Vt0bs_d_v_db__)-(d_FF_d_v_db__*aphit)))/nphit-((Vgscorr-((Vt0bs-Vdsi*parm_delta)-FF*aphit))*d_nphit_d_v_db__)/nphit^2;
        ...
        d_eta_d_v_sb__ = (d_Vgscorr_d_v_sb__-((d_Vt0bs_d_v_sb__)-(d_FF_d_v_sb__*aphit)))/nphit-((Vgscorr-((Vt0bs-Vdsi*parm_delta)-FF*aphit))*d_nphit_d_v_sb__)/nphit^2;
    ...
    eta = (Vgscorr-((Vt0bs-Vdsi*parm_delta)-FF*aphit))/nphit;
        d_eta0_d_v_db__ = (-(-(d_FFpre_d_v_db__*aphit)))/nphit-((Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))*d_nphit_d_v_db__)/nphit^2;
        d_eta0_d_v_gb__ = (d_Vgsi_d_v_gb__-((d_Vt0bs0_d_v_gb__-(d_Vdsi_d_v_gb__*parm_delta))-(d_FFpre_d_v_gb__*aphit)))/nphit-((Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))*d_nphit_d_v_gb__)/nphit^2;
        d_eta0_d_v_sb__ = (-(-(d_FFpre_d_v_sb__*aphit)))/nphit-((Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))*d_nphit_d_v_sb__)/nphit^2;
        d_eta0_d_v_disi__ = (d_Vgsi_d_v_disi__-((d_Vt0bs0_d_v_disi__-(d_Vdsi_d_v_disi__*parm_delta))-(d_FFpre_d_v_disi__*aphit)))/nphit-((Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))*d_nphit_d_v_disi__)/nphit^2;
        d_eta0_d_v_bsi__ = (d_Vgsi_d_v_bsi__-((d_Vt0bs0_d_v_bsi__-(d_Vdsi_d_v_bsi__*parm_delta))-(d_FFpre_d_v_bsi__*aphit)))/nphit-((Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))*d_nphit_d_v_bsi__)/nphit^2;
    eta0 = (Vgsi-((Vt0bs0-Vdsi*parm_delta)-FFpre*aphit))/nphit;
    if eta<=40
            d_Qinv_corr_d_v_db__ = Qref*((1/(1+exp(eta)))*(exp(eta)*d_eta_d_v_db__))+d_Qref_d_v_db__*log(1+exp(eta));
            d_Qinv_corr_d_v_gb__ = Qref*((1/(1+exp(eta)))*(exp(eta)*d_eta_d_v_gb__))+d_Qref_d_v_gb__*log(1+exp(eta));
            d_Qinv_corr_d_v_sb__ = Qref*((1/(1+exp(eta)))*(exp(eta)*d_eta_d_v_sb__))+d_Qref_d_v_sb__*log(1+exp(eta));
        ...
        Qinv_corr = Qref*log(1+exp(eta));
            ...
            d_Qinv_corr_d_v_db__ = Qref*d_eta_d_v_db__+d_Qref_d_v_db__*eta;
            d_Qinv_corr_d_v_gb__ = Qref*d_eta_d_v_gb__+d_Qref_d_v_gb__*eta;
            d_Qinv_corr_d_v_sb__ = Qref*d_eta_d_v_sb__+d_Qref_d_v_sb__*eta;
    ...
    if eta0<=40
            d_Qinv_d_v_db__ = Qref*((1/(1+exp(eta0)))*(exp(eta0)*d_eta0_d_v_db__))+d_Qref_d_v_db__*log(1+exp(eta0));
            d_Qinv_d_v_gb__ = Qref*((1/(1+exp(eta0)))*(exp(eta0)*d_eta0_d_v_gb__))+d_Qref_d_v_gb__*log(1+exp(eta0));
            d_Qinv_d_v_sb__ = Qref*((1/(1+exp(eta0)))*(exp(eta0)*d_eta0_d_v_sb__))+d_Qref_d_v_sb__*log(1+exp(eta0));
        ...
        Qinv = Qref*log(1+exp(eta0));
            ...
            d_Qinv_d_v_db__ = Qref*d_eta0_d_v_db__+d_Qref_d_v_db__*eta0;
            d_Qinv_d_v_gb__ = Qref*d_eta0_d_v_gb__+d_Qref_d_v_gb__*eta0;
            d_Qinv_d_v_sb__ = Qref*d_eta0_d_v_sb__+d_Qref_d_v_sb__*eta0;
    ...
    if parm_leak_select==1
            d_Vt0bs0_vgs0_d_v_db__ = (parm_gamma*((1/(2*sqrt(abs(parm_phib-Vbs))))*(sign(parm_phib-Vbs)*(-d_Vbs_d_v_db__))));
            d_Vt0bs0_vgs0_d_v_gb__ = (parm_gamma*((1/(2*sqrt(abs(parm_phib-Vbs))))*(sign(parm_phib-Vbs)*(-d_Vbs_d_v_gb__))));
            d_Vt0bs0_vgs0_d_v_sb__ = (parm_gamma*((1/(2*sqrt(abs(parm_phib-Vbs))))*(sign(parm_phib-Vbs)*(-d_Vbs_d_v_sb__))));
            d_Vt0bs0_vgs0_d_v_disi__ = (parm_gamma*((1/(2*sqrt(abs(parm_phib-Vbs))))*(sign(parm_phib-Vbs)*(-d_Vbs_d_v_disi__))));
            d_Vt0bs0_vgs0_d_v_bsi__ = (parm_gamma*((1/(2*sqrt(abs(parm_phib-Vbs))))*(sign(parm_phib-Vbs)*(-d_Vbs_d_v_bsi__))));
        Vt0bs0_vgs0 = parm_Vt0+parm_gamma*(sqrt(abs(parm_phib-Vbs))-sqrt(parm_phib));
            d_eVg_vgs0_d_v_db__ = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit)*((-((d_Vt0bs0_vgs0_d_v_db__-(d_Vds_d_v_db__*parm_delta))))/aphit);
            d_eVg_vgs0_d_v_gb__ = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit)*((-((d_Vt0bs0_vgs0_d_v_gb__-(d_Vds_d_v_gb__*parm_delta))))/aphit);
            d_eVg_vgs0_d_v_sb__ = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit)*((-((d_Vt0bs0_vgs0_d_v_sb__-(d_Vds_d_v_sb__*parm_delta))))/aphit);
            d_eVg_vgs0_d_v_disi__ = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit)*((-((d_Vt0bs0_vgs0_d_v_disi__-(d_Vds_d_v_disi__*parm_delta))))/aphit);
            d_eVg_vgs0_d_v_bsi__ = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit)*((-((d_Vt0bs0_vgs0_d_v_bsi__-(d_Vds_d_v_bsi__*parm_delta))))/aphit);
        eVg_vgs0 = exp((0-((Vt0bs0_vgs0-Vds*parm_delta)-0.5*aphit))/aphit);
            d_FF_vgs0_d_v_db__ = -(1*(d_eVg_vgs0_d_v_db__))/(1+eVg_vgs0)^2;
            d_FF_vgs0_d_v_gb__ = -(1*(d_eVg_vgs0_d_v_gb__))/(1+eVg_vgs0)^2;
            d_FF_vgs0_d_v_sb__ = -(1*(d_eVg_vgs0_d_v_sb__))/(1+eVg_vgs0)^2;
            d_FF_vgs0_d_v_disi__ = -(1*(d_eVg_vgs0_d_v_disi__))/(1+eVg_vgs0)^2;
            d_FF_vgs0_d_v_bsi__ = -(1*(d_eVg_vgs0_d_v_bsi__))/(1+eVg_vgs0)^2;
        FF_vgs0 = 1/(1+eVg_vgs0);
            d_eta_vgs0_d_v_db__ = (-((d_Vt0bs0_vgs0_d_v_db__-(d_Vds_d_v_db__*parm_delta))-(aphit*d_FF_vgs0_d_v_db__)))/nphit-((0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))*d_nphit_d_v_db__)/nphit^2;
            d_eta_vgs0_d_v_gb__ = (-((d_Vt0bs0_vgs0_d_v_gb__-(d_Vds_d_v_gb__*parm_delta))-(aphit*d_FF_vgs0_d_v_gb__)))/nphit-((0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))*d_nphit_d_v_gb__)/nphit^2;
            d_eta_vgs0_d_v_sb__ = (-((d_Vt0bs0_vgs0_d_v_sb__-(d_Vds_d_v_sb__*parm_delta))-(aphit*d_FF_vgs0_d_v_sb__)))/nphit-((0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))*d_nphit_d_v_sb__)/nphit^2;
            d_eta_vgs0_d_v_disi__ = (-((d_Vt0bs0_vgs0_d_v_disi__-(d_Vds_d_v_disi__*parm_delta))-(aphit*d_FF_vgs0_d_v_disi__)))/nphit-((0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))*d_nphit_d_v_disi__)/nphit^2;
            d_eta_vgs0_d_v_bsi__ = (-((d_Vt0bs0_vgs0_d_v_bsi__-(d_Vds_d_v_bsi__*parm_delta))-(aphit*d_FF_vgs0_d_v_bsi__)))/nphit-((0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))*d_nphit_d_v_bsi__)/nphit^2;
        eta_vgs0 = (0-((Vt0bs0_vgs0-Vds*parm_delta)-aphit*FF_vgs0))/nphit;
            d_Qinv_corr_vgs0_d_v_db__ = Qref*((1/(1+exp(eta_vgs0)))*(exp(eta_vgs0)*d_eta_vgs0_d_v_db__))+d_Qref_d_v_db__*log(1+exp(eta_vgs0));
            d_Qinv_corr_vgs0_d_v_gb__ = Qref*((1/(1+exp(eta_vgs0)))*(exp(eta_vgs0)*d_eta_vgs0_d_v_gb__))+d_Qref_d_v_gb__*log(1+exp(eta_vgs0));
            d_Qinv_corr_vgs0_d_v_sb__ = Qref*((1/(1+exp(eta_vgs0)))*(exp(eta_vgs0)*d_eta_vgs0_d_v_sb__))+d_Qref_d_v_sb__*log(1+exp(eta_vgs0));
            d_Qinv_corr_vgs0_d_v_disi__ = Qref*((1/(1+exp(eta_vgs0)))*(exp(eta_vgs0)*d_eta_vgs0_d_v_disi__))+d_Qref_d_v_disi__*log(1+exp(eta_vgs0));
            d_Qinv_corr_vgs0_d_v_bsi__ = Qref*((1/(1+exp(eta_vgs0)))*(exp(eta_vgs0)*d_eta_vgs0_d_v_bsi__))+d_Qref_d_v_bsi__*log(1+exp(eta_vgs0));
        Qinv_corr_vgs0 = Qref*log(1+exp(eta_vgs0));
            d_Vdsat_vgs0_d_v_db__ = (Vdsats*(-d_FF_vgs0_d_v_db__))+(phit*d_FF_vgs0_d_v_db__);
            d_Vdsat_vgs0_d_v_gb__ = (Vdsats*(-d_FF_vgs0_d_v_gb__))+(phit*d_FF_vgs0_d_v_gb__);
            d_Vdsat_vgs0_d_v_sb__ = (Vdsats*(-d_FF_vgs0_d_v_sb__))+(phit*d_FF_vgs0_d_v_sb__);
            d_Vdsat_vgs0_d_v_disi__ = (Vdsats*(-d_FF_vgs0_d_v_disi__))+(phit*d_FF_vgs0_d_v_disi__);
            d_Vdsat_vgs0_d_v_bsi__ = (Vdsats*(-d_FF_vgs0_d_v_bsi__))+(phit*d_FF_vgs0_d_v_bsi__);
        Vdsat_vgs0 = Vdsats*(1-FF_vgs0)+phit*FF_vgs0;
            d_Vdratio_vgs0_d_v_db__ = sign(Vds/Vdsat_vgs0)*(d_Vds_d_v_db__/Vdsat_vgs0-(Vds*d_Vdsat_vgs0_d_v_db__)/Vdsat_vgs0^2);
            d_Vdratio_vgs0_d_v_gb__ = sign(Vds/Vdsat_vgs0)*(d_Vds_d_v_gb__/Vdsat_vgs0-(Vds*d_Vdsat_vgs0_d_v_gb__)/Vdsat_vgs0^2);
            d_Vdratio_vgs0_d_v_sb__ = sign(Vds/Vdsat_vgs0)*(d_Vds_d_v_sb__/Vdsat_vgs0-(Vds*d_Vdsat_vgs0_d_v_sb__)/Vdsat_vgs0^2);
            d_Vdratio_vgs0_d_v_disi__ = sign(Vds/Vdsat_vgs0)*(d_Vds_d_v_disi__/Vdsat_vgs0-(Vds*d_Vdsat_vgs0_d_v_disi__)/Vdsat_vgs0^2);
            d_Vdratio_vgs0_d_v_bsi__ = sign(Vds/Vdsat_vgs0)*(d_Vds_d_v_bsi__/Vdsat_vgs0-(Vds*d_Vdsat_vgs0_d_v_bsi__)/Vdsat_vgs0^2);
        Vdratio_vgs0 = abs(Vds/Vdsat_vgs0);
            d_Vdbeta_vgs0_d_v_db__ = d_pow_vapp_d_arg1__(Vdratio_vgs0, parm_beta)*d_Vdratio_vgs0_d_v_db__;
            d_Vdbeta_vgs0_d_v_gb__ = d_pow_vapp_d_arg1__(Vdratio_vgs0, parm_beta)*d_Vdratio_vgs0_d_v_gb__;
            d_Vdbeta_vgs0_d_v_sb__ = d_pow_vapp_d_arg1__(Vdratio_vgs0, parm_beta)*d_Vdratio_vgs0_d_v_sb__;
            d_Vdbeta_vgs0_d_v_disi__ = d_pow_vapp_d_arg1__(Vdratio_vgs0, parm_beta)*d_Vdratio_vgs0_d_v_disi__;
            d_Vdbeta_vgs0_d_v_bsi__ = d_pow_vapp_d_arg1__(Vdratio_vgs0, parm_beta)*d_Vdratio_vgs0_d_v_bsi__;
        Vdbeta_vgs0 = pow_vapp(Vdratio_vgs0, parm_beta);
            d_Vdbetabeta_vgs0_d_v_db__ = d_pow_vapp_d_arg1__(1+Vdbeta_vgs0, 1/parm_beta)*(d_Vdbeta_vgs0_d_v_db__);
            d_Vdbetabeta_vgs0_d_v_gb__ = d_pow_vapp_d_arg1__(1+Vdbeta_vgs0, 1/parm_beta)*(d_Vdbeta_vgs0_d_v_gb__);
            d_Vdbetabeta_vgs0_d_v_sb__ = d_pow_vapp_d_arg1__(1+Vdbeta_vgs0, 1/parm_beta)*(d_Vdbeta_vgs0_d_v_sb__);
            d_Vdbetabeta_vgs0_d_v_disi__ = d_pow_vapp_d_arg1__(1+Vdbeta_vgs0, 1/parm_beta)*(d_Vdbeta_vgs0_d_v_disi__);
            d_Vdbetabeta_vgs0_d_v_bsi__ = d_pow_vapp_d_arg1__(1+Vdbeta_vgs0, 1/parm_beta)*(d_Vdbeta_vgs0_d_v_bsi__);
        Vdbetabeta_vgs0 = pow_vapp(1+Vdbeta_vgs0, 1/parm_beta);
            d_Fsat_vgs0_d_v_db__ = d_Vdratio_vgs0_d_v_db__/Vdbetabeta_vgs0-(Vdratio_vgs0*d_Vdbetabeta_vgs0_d_v_db__)/Vdbetabeta_vgs0^2;
            d_Fsat_vgs0_d_v_gb__ = d_Vdratio_vgs0_d_v_gb__/Vdbetabeta_vgs0-(Vdratio_vgs0*d_Vdbetabeta_vgs0_d_v_gb__)/Vdbetabeta_vgs0^2;
            d_Fsat_vgs0_d_v_sb__ = d_Vdratio_vgs0_d_v_sb__/Vdbetabeta_vgs0-(Vdratio_vgs0*d_Vdbetabeta_vgs0_d_v_sb__)/Vdbetabeta_vgs0^2;
            d_Fsat_vgs0_d_v_disi__ = d_Vdratio_vgs0_d_v_disi__/Vdbetabeta_vgs0-(Vdratio_vgs0*d_Vdbetabeta_vgs0_d_v_disi__)/Vdbetabeta_vgs0^2;
            d_Fsat_vgs0_d_v_bsi__ = d_Vdratio_vgs0_d_v_bsi__/Vdbetabeta_vgs0-(Vdratio_vgs0*d_Vdbetabeta_vgs0_d_v_bsi__)/Vdbetabeta_vgs0^2;
        Fsat_vgs0 = Vdratio_vgs0/Vdbetabeta_vgs0;
            d_Id_vgs0_d_v_db__ = ((Qinv_corr_vgs0*vx0)*d_Fsat_vgs0_d_v_db__+(d_Qinv_corr_vgs0_d_v_db__*vx0)*Fsat_vgs0)*parm_W;
            d_Id_vgs0_d_v_gb__ = ((Qinv_corr_vgs0*vx0)*d_Fsat_vgs0_d_v_gb__+(d_Qinv_corr_vgs0_d_v_gb__*vx0)*Fsat_vgs0)*parm_W;
            d_Id_vgs0_d_v_sb__ = ((Qinv_corr_vgs0*vx0)*d_Fsat_vgs0_d_v_sb__+(d_Qinv_corr_vgs0_d_v_sb__*vx0)*Fsat_vgs0)*parm_W;
            d_Id_vgs0_d_v_disi__ = ((Qinv_corr_vgs0*vx0)*d_Fsat_vgs0_d_v_disi__+(d_Qinv_corr_vgs0_d_v_disi__*vx0)*Fsat_vgs0)*parm_W;
            d_Id_vgs0_d_v_bsi__ = ((Qinv_corr_vgs0*vx0)*d_Fsat_vgs0_d_v_bsi__+(d_Qinv_corr_vgs0_d_v_bsi__*vx0)*Fsat_vgs0)*parm_W;
        Id_vgs0 = ((Qinv_corr_vgs0*vx0)*Fsat_vgs0)*parm_W;
    else
            d_Id_vgs0_d_v_db__ = 0;
            d_Id_vgs0_d_v_gb__ = 0;
            d_Id_vgs0_d_v_sb__ = 0;
        ...
        d_Id_d_v_db__ = (((Qinv_corr*vx0)*d_Fsat_d_v_db__+(d_Qinv_corr_d_v_db__*vx0)*Fsat)*parm_W)+d_Id_vgs0_d_v_db__;
        d_Id_d_v_gb__ = (((Qinv_corr*vx0)*d_Fsat_d_v_gb__+(d_Qinv_corr_d_v_gb__*vx0)*Fsat)*parm_W)+d_Id_vgs0_d_v_gb__;
        d_Id_d_v_sb__ = (((Qinv_corr*vx0)*d_Fsat_d_v_sb__+(d_Qinv_corr_d_v_sb__*vx0)*Fsat)*parm_W)+d_Id_vgs0_d_v_sb__;
        d_Id_d_v_disi__ = (((Qinv_corr*vx0)*d_Fsat_d_v_disi__+(d_Qinv_corr_d_v_disi__*vx0)*Fsat)*parm_W)+d_Id_vgs0_d_v_disi__;
        d_Id_d_v_bsi__ = (((Qinv_corr*vx0)*d_Fsat_d_v_bsi__+(d_Qinv_corr_d_v_bsi__*vx0)*Fsat)*parm_W)+d_Id_vgs0_d_v_bsi__;
    Id = ((Qinv_corr*vx0)*Fsat)*parm_W+Id_vgs0;
    ...
    x = 1-Fsatq;
        d_den_d_v_db__ = (15*(1+x))*(d_x_d_v_db__)+(15*(d_x_d_v_db__))*(1+x);
        d_den_d_v_gb__ = (15*(1+x))*(d_x_d_v_gb__)+(15*(d_x_d_v_gb__))*(1+x);
        d_den_d_v_sb__ = (15*(1+x))*(d_x_d_v_sb__)+(15*(d_x_d_v_sb__))*(1+x);
        d_den_d_v_disi__ = (15*(1+x))*(d_x_d_v_disi__)+(15*(d_x_d_v_disi__))*(1+x);
        d_den_d_v_bsi__ = (15*(1+x))*(d_x_d_v_bsi__)+(15*(d_x_d_v_bsi__))*(1+x);
    den = (15*(1+x))*(1+x);
        d_qsc_d_v_db__ = (Qinv*((((12*d_x_d_v_db__))+((8*x)*d_x_d_v_db__+(8*d_x_d_v_db__)*x))+(((4*x)*x)*d_x_d_v_db__+((4*x)*d_x_d_v_db__+(4*d_x_d_v_db__)*x)*x))+d_Qinv_d_v_db__*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den-((Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))*d_den_d_v_db__)/den^2;
        d_qsc_d_v_gb__ = (Qinv*((((12*d_x_d_v_gb__))+((8*x)*d_x_d_v_gb__+(8*d_x_d_v_gb__)*x))+(((4*x)*x)*d_x_d_v_gb__+((4*x)*d_x_d_v_gb__+(4*d_x_d_v_gb__)*x)*x))+d_Qinv_d_v_gb__*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den-((Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))*d_den_d_v_gb__)/den^2;
        d_qsc_d_v_sb__ = (Qinv*((((12*d_x_d_v_sb__))+((8*x)*d_x_d_v_sb__+(8*d_x_d_v_sb__)*x))+(((4*x)*x)*d_x_d_v_sb__+((4*x)*d_x_d_v_sb__+(4*d_x_d_v_sb__)*x)*x))+d_Qinv_d_v_sb__*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den-((Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))*d_den_d_v_sb__)/den^2;
        d_qsc_d_v_disi__ = (Qinv*((((12*d_x_d_v_disi__))+((8*x)*d_x_d_v_disi__+(8*d_x_d_v_disi__)*x))+(((4*x)*x)*d_x_d_v_disi__+((4*x)*d_x_d_v_disi__+(4*d_x_d_v_disi__)*x)*x))+d_Qinv_d_v_disi__*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den-((Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))*d_den_d_v_disi__)/den^2;
        d_qsc_d_v_bsi__ = (Qinv*((((12*d_x_d_v_bsi__))+((8*x)*d_x_d_v_bsi__+(8*d_x_d_v_bsi__)*x))+(((4*x)*x)*d_x_d_v_bsi__+((4*x)*d_x_d_v_bsi__+(4*d_x_d_v_bsi__)*x)*x))+d_Qinv_d_v_bsi__*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den-((Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))*d_den_d_v_bsi__)/den^2;
    qsc = (Qinv*(((6+12*x)+(8*x)*x)+((4*x)*x)*x))/den;
        d_qdc_d_v_db__ = (Qinv*((((8*d_x_d_v_db__))+((12*x)*d_x_d_v_db__+(12*d_x_d_v_db__)*x))+(((6*x)*x)*d_x_d_v_db__+((6*x)*d_x_d_v_db__+(6*d_x_d_v_db__)*x)*x))+d_Qinv_d_v_db__*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))/den-((Qinv*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))*d_den_d_v_db__)/den^2;
        d_qdc_d_v_gb__ = (Qinv*((((8*d_x_d_v_gb__))+((12*x)*d_x_d_v_gb__+(12*d_x_d_v_gb__)*x))+(((6*x)*x)*d_x_d_v_gb__+((6*x)*d_x_d_v_gb__+(6*d_x_d_v_gb__)*x)*x))+d_Qinv_d_v_gb__*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))/den-((Qinv*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))*d_den_d_v_gb__)/den^2;
        d_qdc_d_v_sb__ = (Qinv*((((8*d_x_d_v_sb__))+((12*x)*d_x_d_v_sb__+(12*d_x_d_v_sb__)*x))+(((6*x)*x)*d_x_d_v_sb__+((6*x)*d_x_d_v_sb__+(6*d_x_d_v_sb__)*x)*x))+d_Qinv_d_v_sb__*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))/den-((Qinv*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))*d_den_d_v_sb__)/den^2;
        d_qdc_d_v_disi__ = (Qinv*((((8*d_x_d_v_disi__))+((12*x)*d_x_d_v_disi__+(12*d_x_d_v_disi__)*x))+(((6*x)*x)*d_x_d_v_disi__+((6*x)*d_x_d_v_disi__+(6*d_x_d_v_disi__)*x)*x))+d_Qinv_d_v_disi__*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))/den-((Qinv*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))*d_den_d_v_disi__)/den^2;
        d_qdc_d_v_bsi__ = (Qinv*((((8*d_x_d_v_bsi__))+((12*x)*d_x_d_v_bsi__+(12*d_x_d_v_bsi__)*x))+(((6*x)*x)*d_x_d_v_bsi__+((6*x)*d_x_d_v_bsi__+(6*d_x_d_v_bsi__)*x)*x))+d_Qinv_d_v_bsi__*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))/den-((Qinv*(((4+8*x)+(12*x)*x)+((6*x)*x)*x))*d_den_d_v_bsi__)/den^2;
    ...
    if Vdsi<=tol
            d_kq2_d_v_gb__ = ((((2*1.6022e-19)/me)*d_Vdsi_d_v_gb__)/(vx0*vx0))*10000;
            d_kq2_d_v_disi__ = ((((2*1.6022e-19)/me)*d_Vdsi_d_v_disi__)/(vx0*vx0))*10000;
            d_kq2_d_v_bsi__ = ((((2*1.6022e-19)/me)*d_Vdsi_d_v_bsi__)/(vx0*vx0))*10000;
        ...
        kq4 = kq2*kq2;
            d_qsb_d_v_db__ = d_Qinv_d_v_db__*((0.5-kq2/24)+kq4/80);
            d_qsb_d_v_gb__ = Qinv*((-(d_kq2_d_v_gb__/24))+(d_kq4_d_v_gb__/80))+d_Qinv_d_v_gb__*((0.5-kq2/24)+kq4/80);
            d_qsb_d_v_sb__ = d_Qinv_d_v_sb__*((0.5-kq2/24)+kq4/80);
            d_qsb_d_v_disi__ = Qinv*((-(d_kq2_d_v_disi__/24))+(d_kq4_d_v_disi__/80))+d_Qinv_d_v_disi__*((0.5-kq2/24)+kq4/80);
            d_qsb_d_v_bsi__ = Qinv*((-(d_kq2_d_v_bsi__/24))+(d_kq4_d_v_bsi__/80))+d_Qinv_d_v_bsi__*((0.5-kq2/24)+kq4/80);
        qsb = Qinv*((0.5-kq2/24)+kq4/80);
            d_qdb_d_v_db__ = d_Qinv_d_v_db__*((0.5-0.125*kq2)+kq4/16);
            d_qdb_d_v_gb__ = Qinv*((-(0.125*d_kq2_d_v_gb__))+(d_kq4_d_v_gb__/16))+d_Qinv_d_v_gb__*((0.5-0.125*kq2)+kq4/16);
            d_qdb_d_v_sb__ = d_Qinv_d_v_sb__*((0.5-0.125*kq2)+kq4/16);
            d_qdb_d_v_disi__ = Qinv*((-(0.125*d_kq2_d_v_disi__))+(d_kq4_d_v_disi__/16))+d_Qinv_d_v_disi__*((0.5-0.125*kq2)+kq4/16);
            d_qdb_d_v_bsi__ = Qinv*((-(0.125*d_kq2_d_v_bsi__))+(d_kq4_d_v_bsi__/16))+d_Qinv_d_v_bsi__*((0.5-0.125*kq2)+kq4/16);
        qdb = Qinv*((0.5-0.125*kq2)+kq4/16);
    else
            d_kq_d_v_gb__ = (((1/(2*sqrt(((2*1.6022e-19)/me)*Vdsi)))*(((2*1.6022e-19)/me)*d_Vdsi_d_v_gb__))/vx0)*100;
            d_kq_d_v_disi__ = (((1/(2*sqrt(((2*1.6022e-19)/me)*Vdsi)))*(((2*1.6022e-19)/me)*d_Vdsi_d_v_disi__))/vx0)*100;
            d_kq_d_v_bsi__ = (((1/(2*sqrt(((2*1.6022e-19)/me)*Vdsi)))*(((2*1.6022e-19)/me)*d_Vdsi_d_v_bsi__))/vx0)*100;
        ...
        kq2 = kq*kq;
            d_qsb_d_v_db__ = d_Qinv_d_v_db__*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
            d_qsb_d_v_gb__ = Qinv*((((1/sqrt(kq^2+1))*d_kq_d_v_gb__)/kq-(asinh(kq)*d_kq_d_v_gb__)/kq^2)-(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_gb__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_gb__)/kq2^2))+d_Qinv_d_v_gb__*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
            d_qsb_d_v_sb__ = d_Qinv_d_v_sb__*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
            d_qsb_d_v_disi__ = Qinv*((((1/sqrt(kq^2+1))*d_kq_d_v_disi__)/kq-(asinh(kq)*d_kq_d_v_disi__)/kq^2)-(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_disi__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_disi__)/kq2^2))+d_Qinv_d_v_disi__*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
            d_qsb_d_v_bsi__ = Qinv*((((1/sqrt(kq^2+1))*d_kq_d_v_bsi__)/kq-(asinh(kq)*d_kq_d_v_bsi__)/kq^2)-(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_bsi__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_bsi__)/kq2^2))+d_Qinv_d_v_bsi__*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
        qsb = Qinv*(asinh(kq)/kq-(sqrt(kq2+1)-1)/kq2);
            d_qdb_d_v_db__ = d_Qinv_d_v_db__*((sqrt(kq2+1)-1)/kq2);
            d_qdb_d_v_gb__ = Qinv*(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_gb__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_gb__)/kq2^2)+d_Qinv_d_v_gb__*((sqrt(kq2+1)-1)/kq2);
            d_qdb_d_v_sb__ = d_Qinv_d_v_sb__*((sqrt(kq2+1)-1)/kq2);
            d_qdb_d_v_disi__ = Qinv*(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_disi__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_disi__)/kq2^2)+d_Qinv_d_v_disi__*((sqrt(kq2+1)-1)/kq2);
            d_qdb_d_v_bsi__ = Qinv*(((1/(2*sqrt(kq2+1)))*(d_kq2_d_v_bsi__))/kq2-((sqrt(kq2+1)-1)*d_kq2_d_v_bsi__)/kq2^2)+d_Qinv_d_v_bsi__*((sqrt(kq2+1)-1)/kq2);
    ...
    Qb = ((-parm_type*parm_W)*Leff)*((parm_Cg*parm_gamma)*sqrt(abs(psis-Vbsi))+(((a-1)/(1*a))*Qinv)*(1-qi));
        d_etai_d_v_db__ = (-(-(d_FF_d_v_db__*aphit)))/nphit-((Vgsi-(Vt0bs0-FF*aphit))*d_nphit_d_v_db__)/nphit^2;
        ...
        d_etai_d_v_sb__ = (-(-(d_FF_d_v_sb__*aphit)))/nphit-((Vgsi-(Vt0bs0-FF*aphit))*d_nphit_d_v_sb__)/nphit^2;
    ...
    if etai<=40
            d_Qinvi_d_v_db__ = Qref*((1/(1+exp(etai)))*(exp(etai)*d_etai_d_v_db__))+d_Qref_d_v_db__*log(1+exp(etai));
            d_Qinvi_d_v_gb__ = Qref*((1/(1+exp(etai)))*(exp(etai)*d_etai_d_v_gb__))+d_Qref_d_v_gb__*log(1+exp(etai));
            d_Qinvi_d_v_sb__ = Qref*((1/(1+exp(etai)))*(exp(etai)*d_etai_d_v_sb__))+d_Qref_d_v_sb__*log(1+exp(etai));
        ...
        Qinvi = Qref*log(1+exp(etai));
            ...
            d_Qinvi_d_v_db__ = Qref*d_etai_d_v_db__+d_Qref_d_v_db__*etai;
            d_Qinvi_d_v_gb__ = Qref*d_etai_d_v_gb__+d_Qref_d_v_gb__*etai;
            d_Qinvi_d_v_sb__ = Qref*d_etai_d_v_sb__+d_Qref_d_v_sb__*etai;
    ...
    dQinv = Qinv-Qinvi;
        d_dibl_corr_d_v_db__ = (((1-FF0)*(1-Fsatq))*qi)*d_dQinv_d_v_db__+(((1-FF0)*(1-Fsatq))*d_qi_d_v_db__+((1-FF0)*(-d_Fsatq_d_v_db__))*qi)*dQinv;
        d_dibl_corr_d_v_gb__ = (((1-FF0)*(1-Fsatq))*qi)*d_dQinv_d_v_gb__+(((1-FF0)*(1-Fsatq))*d_qi_d_v_gb__+((1-FF0)*(-d_Fsatq_d_v_gb__)+(-d_FF0_d_v_gb__)*(1-Fsatq))*qi)*dQinv;
        d_dibl_corr_d_v_sb__ = (((1-FF0)*(1-Fsatq))*qi)*d_dQinv_d_v_sb__+(((1-FF0)*(1-Fsatq))*d_qi_d_v_sb__+((1-FF0)*(-d_Fsatq_d_v_sb__))*qi)*dQinv;
        d_dibl_corr_d_v_disi__ = (((1-FF0)*(1-Fsatq))*qi)*d_dQinv_d_v_disi__+(((1-FF0)*(1-Fsatq))*d_qi_d_v_disi__+((1-FF0)*(-d_Fsatq_d_v_disi__)+(-d_FF0_d_v_disi__)*(1-Fsatq))*qi)*dQinv;
        d_dibl_corr_d_v_bsi__ = (((1-FF0)*(1-Fsatq))*qi)*d_dQinv_d_v_bsi__+(((1-FF0)*(1-Fsatq))*d_qi_d_v_bsi__+((1-FF0)*(-d_Fsatq_d_v_bsi__)+(-d_FF0_d_v_bsi__)*(1-Fsatq))*qi)*dQinv;
    ...
    Vt0y = parm_Vt0+parm_gamma*(sqrt(abs(parm_phib-parm_type*v_bdi__))-sqrt(parm_phib));
        d_Fs_arg_d_v_db__ = ((-(-((Vdsi*parm_delta)*d_Fsat_d_v_db__))))/(1.1*nphit)-(((Vgsraw-(Vt0x-(Vdsi*parm_delta)*Fsat))+aphit*0.5)*(1.1*d_nphit_d_v_db__))/(1.1*nphit)^2;
        ...
        d_Fs_arg_d_v_sb__ = ((-(-((Vdsi*parm_delta)*d_Fsat_d_v_sb__))))/(1.1*nphit)-(((Vgsraw-(Vt0x-(Vdsi*parm_delta)*Fsat))+aphit*0.5)*(1.1*d_nphit_d_v_sb__))/(1.1*nphit)^2;
    ...
    if Fs_arg<=40
        ...
        Fs = 1+exp(Fs_arg);
            d_FFx_d_v_db__ = -(nphit*((1/Fs)*d_Fs_d_v_db__)+d_nphit_d_v_db__*log(Fs));
            d_FFx_d_v_gb__ = d_Vgsraw_d_v_gb__-(nphit*((1/Fs)*d_Fs_d_v_gb__)+d_nphit_d_v_gb__*log(Fs));
            d_FFx_d_v_sb__ = -(nphit*((1/Fs)*d_Fs_d_v_sb__)+d_nphit_d_v_sb__*log(Fs));
        ...
        FFx = Vgsraw-nphit*log(Fs);
            ...
            d_Fs_d_v_bsi__ = 0;
        Fs = 0;
            d_FFx_d_v_db__ = -(nphit*d_Fs_arg_d_v_db__+d_nphit_d_v_db__*Fs_arg);
            d_FFx_d_v_gb__ = d_Vgsraw_d_v_gb__-(nphit*d_Fs_arg_d_v_gb__+d_nphit_d_v_gb__*Fs_arg);
            d_FFx_d_v_sb__ = -(nphit*d_Fs_arg_d_v_sb__+d_nphit_d_v_sb__*Fs_arg);
        ...
        d_Fd_arg_d_v_db__ = ((-(-((Vdsi*parm_delta)*d_Fsat_d_v_db__))))/(1.1*nphit)-(((Vgdraw-(Vt0y-(Vdsi*parm_delta)*Fsat))+aphit*0.5)*(1.1*d_nphit_d_v_db__))/(1.1*nphit)^2;
        ...
        d_Fd_arg_d_v_sb__ = ((-(-((Vdsi*parm_delta)*d_Fsat_d_v_sb__))))/(1.1*nphit)-(((Vgdraw-(Vt0y-(Vdsi*parm_delta)*Fsat))+aphit*0.5)*(1.1*d_nphit_d_v_sb__))/(1.1*nphit)^2;
    ...
    if Fd_arg<=40
        ...
        Fd = 1+exp(Fd_arg);
            d_FFy_d_v_db__ = -(nphit*((1/Fd)*d_Fd_d_v_db__)+d_nphit_d_v_db__*log(Fd));
            d_FFy_d_v_gb__ = d_Vgdraw_d_v_gb__-(nphit*((1/Fd)*d_Fd_d_v_gb__)+d_nphit_d_v_gb__*log(Fd));
            d_FFy_d_v_sb__ = -(nphit*((1/Fd)*d_Fd_d_v_sb__)+d_nphit_d_v_sb__*log(Fd));
        ...
        FFy = Vgdraw-nphit*log(Fd);
            ...
            d_Fd_d_v_bsi__ = 0;
        Fd = 0;
            d_FFy_d_v_db__ = -(nphit*d_Fd_arg_d_v_db__+d_nphit_d_v_db__*Fd_arg);
            d_FFy_d_v_gb__ = d_Vgdraw_d_v_gb__-(nphit*d_Fd_arg_d_v_gb__+d_nphit_d_v_gb__*Fd_arg);
            d_FFy_d_v_sb__ = -(nphit*d_Fd_arg_d_v_sb__+d_nphit_d_v_sb__*Fd_arg);
        ...
        d_Qsif_d_v_gb__ = (parm_type*(parm_Cif+parm_CC*Vgsraw))*d_FFx_d_v_gb__+(parm_type*((parm_CC*d_Vgsraw_d_v_gb__)))*FFx;
        ...
        d_Qsif_d_v_bsi__ = (parm_type*(parm_Cif+parm_CC*Vgsraw))*d_FFx_d_v_bsi__+(parm_type*((parm_CC*d_Vgsraw_d_v_bsi__)))*FFx;
    Qsif = (parm_type*(parm_Cif+parm_CC*Vgsraw))*FFx;
        d_Qdif_d_v_db__ = (parm_type*(parm_Cif+parm_CC*Vgdraw))*d_FFy_d_v_db__;
        d_Qdif_d_v_gb__ = (parm_type*(parm_Cif+parm_CC*Vgdraw))*d_FFy_d_v_gb__+(parm_type*((parm_CC*d_Vgdraw_d_v_gb__)))*FFy;
        d_Qdif_d_v_sb__ = (parm_type*(parm_Cif+parm_CC*Vgdraw))*d_FFy_d_v_sb__;
        d_Qdif_d_v_disi__ = (parm_type*(parm_Cif+parm_CC*Vgdraw))*d_FFy_d_v_disi__+(parm_type*((parm_CC*d_Vgdraw_d_v_disi__)))*FFy;
        d_Qdif_d_v_bsi__ = (parm_type*(parm_Cif+parm_CC*Vgdraw))*d_FFy_d_v_bsi__+(parm_type*((parm_CC*d_Vgdraw_d_v_bsi__)))*FFy;
    ...
    q_i_gb__ = q_i_gb__ + Qg;
        d_f_v_qg_as_vg_d_v_db__ = d_f_v_qg_as_vg_d_v_db__+(((d_Qg_d_v_db__/parm_W)/parm_Lgdr)*1000000);
        d_f_v_qg_as_vg_d_v_gb__ = d_f_v_qg_as_vg_d_v_gb__+(((d_Qg_d_v_gb__/parm_W)/parm_Lgdr)*1000000);
        d_f_v_qg_as_vg_d_v_sb__ = d_f_v_qg_as_vg_d_v_sb__+(((d_Qg_d_v_sb__/parm_W)/parm_Lgdr)*1000000);
        d_f_v_qg_as_vg_d_v_disi__ = d_f_v_qg_as_vg_d_v_disi__+(((d_Qg_d_v_disi__/parm_W)/parm_Lgdr)*1000000);
        d_f_v_qg_as_vg_d_v_bsi__ = d_f_v_qg_as_vg_d_v_bsi__+(((d_Qg_d_v_bsi__/parm_W)/parm_Lgdr)*1000000);
    % contribution for v_qg_as_vg;
    f_v_qg_as_vg__ = f_v_qg_as_vg__ + ((Qg/parm_W)/parm_Lgdr)*1000000;
    ...
    fe__(2) = -i_qg_as_vg__+i_gs__+i_gd__+i_gsi__+i_gdi__ + f_i_gb__;
    qe__(2) = 0 + q_i_gb__;
    ...
    qi__(2) = -q_i_bdi__-q_i_ddi__+q_i_sis__ - q_i_bsi__;
        d_fi_d_X__(3,1) = -d_f_v_qg_as_vg_d_v_db__;
        d_qi_d_X__(3,1) = -d_q_v_qg_as_vg_d_v_db__;
        d_fi_d_X__(3,2) = (-1)-d_f_v_qg_as_vg_d_v_gb__;
        d_qi_d_X__(3,2) = -d_q_v_qg_as_vg_d_v_gb__;
        d_fi_d_X__(3,3) = -d_f_v_qg_as_vg_d_v_sb__;
        d_qi_d_X__(3,3) = -d_q_v_qg_as_vg_d_v_sb__;
        d_fi_d_X__(3,4) = (1);
        d_fi_d_Y__(3,1) = -d_f_v_qg_as_vg_d_v_disi__;
        d_qi_d_Y__(3,1) = -d_q_v_qg_as_vg_d_v_disi__;
        d_fi_d_Y__(3,2) = -d_f_v_qg_as_vg_d_v_bsi__;
        d_qi_d_Y__(3,2) = -d_q_v_qg_as_vg_d_v_bsi__;
    % output for i_qg_as_vg (internal unknown)
    fi__(3) = -v_gb__+v_qg_as_vb__ - f_v_qg_as_vg__;
    qi__(3) = 0 - q_v_qg_as_vg__;
end

function [eonames, iunames, ienames] = get_oui_names__(MOD__)
    eonames = {'idb', 'igb', 'isb', 'iqg_as_vb'};
    iunames = {'v_disi', 'v_bsi', 'i_qg_as_vg'};
    ienames = {'KCL for i_disi', 'KCL for i_bsi', 'KVL for v_qg_as_vg'};
end
